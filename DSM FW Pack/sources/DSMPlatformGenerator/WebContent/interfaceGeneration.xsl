	...
	<xsl:template match="/">
      	...
      	<html>
			...
			<form action="GenerateDSMLanguagesAndPlatform" method="post">
				...
				<br/>
				<input type="file" title="Domain syntax" value="Domain syntax" />
				<br/><br/>
				<input type="file" title="PM" value="PM" />
				<br/><br/>
				<br/><br/>
