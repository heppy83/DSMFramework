...
/*global YAHOO */
/**
 * Class that extends Terminal to differenciate Operation terminals input
 * @class WireIt.util.TerminalInputOperation
 * @extends WireIt.Terminal
 * @constructor
 * @param {HTMLElement} parentEl Parent dom element
 * @param {Object} options configuration object
 * @param {WireIt.Container} container (Optional) Container containing this terminal
 */
WireIt.util.TerminalInputOperation = function(parentEl, options, container) {
    WireIt.util.TerminalInputOperation.superclass.constructor.call(this,parentEl, options, container);
};

YAHOO.lang.extend(WireIt.util.TerminalInputOperation, WireIt.Terminal, {
     ...
     * @type String
     */
    xtype: "WireIt.TerminalInputOperation",
    ...
    /** 
         ...
         * @type String
         */
    className: "WireIt-Terminal-InputOperation",
    ...
    /** 
         ...
         * @type String
         */
    connectedClassName: "WireIt-Terminal-InputOperation-connected",
    ...
    /** 
         ...
         * @type String
         */
    dropinviteClassName: "WireIt-Terminal-InputOperation-dropinvite"
 ...
 * @param {WireIt.Container} container (Optional) Container containing this terminal
 */
WireIt.util.TerminalOutputOperation = function(parentEl, options, container) {
    WireIt.util.TerminalOutputOperation.superclass.constructor.call(this,parentEl, options, container);
};

YAHOO.lang.extend(WireIt.util.TerminalOutputOperation, WireIt.Terminal, {
     ...
     * @type String
     */
    xtype: "WireIt.TerminalOutputOperation",
    ...
    /** 
         ...
         * @type String
         */
    className: "WireIt-Terminal-OutputOperation",
    ...
    /** 
         ...
         * @type String
         */
    connectedClassName: "WireIt-Terminal-OutputOperation-connected",
    ...
    /** 
         ...
         * @type String
         */
    dropinviteClassName: "WireIt-Terminal-OutputOperation-dropinvite"
...
YAHOO.lang.extend(GlobalVariable, WireIt.Container, {
    ...
    */
    ...
    minimizedTerminal:function(terminalConfig){
        if(terminalConfig.offsetPosition.left){
            terminalConfig.offsetPosition.left=115;
        }else if(terminalConfig.offsetPosition.right){
            terminalConfig.offsetPosition.right=115;
        }
    },
    ...
    expandedTerminal:function(terminalConfig){
        ...
        if(terminalConfig.offsetPosition.left){
            terminalConfig.offsetPosition.left=-16;
        }else if(terminalConfig.offsetPosition.right){
            terminalConfig.offsetPosition.right=-16;
        }
    },
    ...
    addTerminal: function(terminalConfig) {
        ...
        if(terminalConfig.ddConfig.type == 'inputparameter'){
    ...
    */
    ...
    minimize_: function() {
        if(this.expanded_) {
            YAHOO.util.Dom.setStyle(this.closeButton, 'left', '40px');
...
YAHOO.lang.extend(Split, WireIt.Container, {
    ...
    minimize_: function() {
        if(this.expanded_) {
            YAHOO.util.Dom.setStyle(this.closeButton, 'left', '16px');
            $(this.bodyEl).parent().removeClass('expanded').addClass('minimized').css('margin-left', 0);
            //set terminals operation
            for(var j=0;j<this.terminals.length;j++){
 ...
 */
    ...
    */
        ...
        minimizedTerminal:function(terminalConfig){
            if(terminalConfig.ddConfig.type == 'input'){
                terminalConfig.el.style.left = "107px";
                terminalConfig.el.style.top="15px";
            }else if(terminalConfig.ddConfig.type == 'output'){
                terminalConfig.el.style.right = "107px";
                terminalConfig.el.style.top="15px";
            }
        },
    ...
    */
            ...
            if(!this.expanded_) {
                ...
                for(var j=0;j<this.terminals.length;j++){
                    this.expandedTerminal(this.terminals[j]);
                                ...
                                for(var i=0;i<this.terminals.length;i++){
                                    if(this.terminals[i].offsetPosition && (this.terminals[i].ddConfig.type == 'inputparameter' || this.terminals[i].ddConfig.type == 'outputparameter' )){
        ...
        minimize_: function() {
            if(this.expanded_) {
                ...
                Dom.setStyle(this.closeButton, 'left', '110px');
                this.expanded_ = false;
                this.redrawAllWires();
        ...
        onAddWire: function(event, args) {
            ...
            if(args[0].terminal2.name){
                ...
                // Switch the order of the terminals if tgt as the "alwaysSrc" property
//                var term1 = this.terminal;
//                var term2_ = targetTerminalProxy.terminal;
//                if(term2.alwaysSrc) {
//                    term1 = targetTerminalProxy.terminal;
//                    term2 = this.terminal;
//                }
