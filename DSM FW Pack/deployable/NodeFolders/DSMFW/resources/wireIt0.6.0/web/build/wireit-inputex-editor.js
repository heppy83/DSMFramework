...
YAHOO.lang.extend(WireIt.util.TerminalInputParameter, WireIt.Terminal, {
	...
	/** 
         ...
         * @type String
         */
	connectedClassName: "WireIt-Terminal2-connected",
	...
	/** 
         ...
         * @type String
         */
	dropinviteClassName: "WireIt-Terminal2-dropinvite"
...
(function() {
	...
	disable: function() {
            ...
            //this.divEl.removeChild(this.fieldContainer);
        },
...
(function() {
     ...
     * </ul>
     */
    inputEx.InputParameterField = function(options) {
        inputEx.InputParameterField.superclass.constructor.call(this, options);
    ...
    lang.extend(inputEx.InputParameterField, inputEx.Field, {
        /**
         * Set the default values of the options
         * @param {Object} options Options object as passed to the constructor
         */
	setOptions: function(options) {
            inputEx.InputParameterField.superclass.setOptions.call(this, options);
        ...
        setValue: function(value, sendUpdatedEvt) {
            ...
            // call parent class method to set style and fire updatedEvt
            inputEx.InputParameterField.superclass.setValue.call(this, value, sendUpdatedEvt);
        },
	...
	getStateString: function(state) {
            ...
            return inputEx.InputParameterField.superclass.getStateString.call(this, state);
	},
         ...
         */
        setClassFromState: function() {
            inputEx.InputParameterField.superclass.setClassFromState.call(this);
	 ...
	 */
	onFocus: function(e) {
            inputEx.InputParameterField.superclass.onFocus.call(this,e);
    ...
    inputEx.registerType("inputParameter", inputEx.InputParameterField, [
        { type: 'string', label: 'Type invite', name: 'typeInvite', value: ''},
        { type: 'integer', label: 'Size', name: 'size', value: 20},
        { type: 'integer', label: 'Min. length', name: 'minLength', value: 0}
    ]);
...
(function() {
     ...
     * </ul>
     */
    inputEx.OutputParameterField = function(options) {
        inputEx.OutputParameterField.superclass.constructor.call(this, options);
    ...
    lang.extend(inputEx.OutputParameterField, inputEx.Field, {
        /**
         * Set the default values of the options
         * @param {Object} options Options object as passed to the constructor
         */
	setOptions: function(options) {
            inputEx.OutputParameterField.superclass.setOptions.call(this, options);
        ...
        setValue: function(value, sendUpdatedEvt) {
            ...
            // call parent class method to set style and fire updatedEvt
            inputEx.OutputParameterField.superclass.setValue.call(this, value, sendUpdatedEvt);
        },
	...
	getStateString: function(state) {
            ...
            return inputEx.OutputParameterField.superclass.getStateString.call(this, state);
	},
         ...
         */
        setClassFromState: function() {
            inputEx.OutputParameterField.superclass.setClassFromState.call(this);
	 ...
	 */
	onFocus: function(e) {
            inputEx.OutputParameterField.superclass.onFocus.call(this,e);
    ...
    inputEx.registerType("outputParameter", inputEx.OutputParameterField, [
        { type: 'string', label: 'Type invite', name: 'typeInvite', value: ''},
        { type: 'integer', label: 'Size', name: 'size', value: 20},
        { type: 'integer', label: 'Min. length', name: 'minLength', value: 0}
    ]);
...
WireIt.BaseEditor.defaultOptions = {
    ...
    propertiesFields: [
        ...
        {"type": "text", "name": "description", label: "Description", cols: 50, rows: 4}
    ],
