...
/*****
 ** Creo una classe wire2 che estende la classe WireIt.Wire
 **
 ******/
WireIt.Wire2 = function( terminal1, terminal2, parentEl, options) {
    WireIt.Wire2.superclass.constructor.call(this, terminal1, terminal2, parentEl, options);
};

YAHOO.lang.extend(WireIt.Wire2, WireIt.Wire, {
	
    xtype: "WireIt.Wire2",
    className: "WireIt-Wire2",
    //255;105;180
...
YAHOO.lang.extend(GlobalVariable, WireIt.FormContainer, {
 ...
 */
    ...
    */
        ...
        render: function() {
            ...
            var self = this;
            //this.bodyEl.style.minHeight =  (Math.max(i * 30, j * 30) + 30) + 'px';
    ...
    */
        ...
        //                    var wire = args[0],
        //                    src = wire.terminal1,
        //                    target = wire.terminal2;
        //                    if(src.container && target.container.component) {
        //                        this.component.getComposition().connect(src.container.component, src.options.name.replace(/^output_/, ''), target.container.component, target.options.name.replace(/^input_/, ''));
        //                    } 
        },
        ...
        //            src = wire.terminal1,
        //            target = wire.terminal2;
        //            if(src.container.component && target.container.component) {
        //                this.component.getComposition().disconnect(src.container.component, src.options.name.replace(/^output_/, ''), target.container.component, target.options.name.replace(/^input_/, ''));
        //            }  
        },

        onCloseButton: function(event, args) {
            ComponentContainer.superclass.onCloseButton.call(this, event, args);
        //this.component.getComposition().removeComponent(this.component);
        }
    });
